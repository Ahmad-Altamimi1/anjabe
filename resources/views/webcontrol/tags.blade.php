                ...
                <table style="direction: rtl;" id="datable_5" class="table table-hover w-100 display">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                        ...
                                        foreach ($groups as $group) {
                                            ...
                                            if (in_array($poststag->id, $str_arr)) {

                                                foreach ($posts as $postsgroupnum) {
                                                    if ($postsgroupnum->TOPIC == $group->id) {
                                                        $num++;
                                                    }
                                                }
                            ...
                            <td><a class="btn btn-primary" type="button" data-toggle="modal" data-target="#exampleModalLarge{{ $poststag->id }}">المزيد من المعلومات</a></td>
                            <td><a class="btn btn-primary" type="button" href="/posts/tags/{{ $poststag->id }}/edit">تعديل</a></td>

                            @if ($num == 0)
                            <td><a type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal{{ $poststag->id }}">حذف</a></td>
                            @endif
