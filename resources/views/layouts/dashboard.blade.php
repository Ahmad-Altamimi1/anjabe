    ...
    <head>
        ...
        <!-- select2 CSS -->
        <link href="{{ asset('control/vendors/select2/dist/css/select2.min.css') }}" rel="stylesheet"
            type="text/css" />
        ...
        <!-- Bootstrap Dropzone CSS -->
        <link href="{{ asset('control/vendors/dropify/dist/css/dropify.min.css') }}" rel="stylesheet"
            type="text/css" />
    ...
    <body>
                            ...
                            @if (Auth::user()->admin || Auth::user()->B2)
                                <li class="nav-item">
                                    <a class="nav-link" href="javascript:void(0);" data-toggle="collapse"
                                        data-target="#slider_drp">
                                        <i class="ion ion-ios-apps"></i>
                                        <span class="nav-link-text">السلايدر</span>
                                    </a>
                                    <ul id="slider_drp" class="nav flex-column collapse collapse-level-1">
                                        <li class="nav-item">
                                            <ul class="nav flex-column">
                                                <li class="nav-item">
                                                    <a class="nav-link" href="/sliders">السلايدر</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="/slider/create">إضافة سلايدر جديد</a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                        ...
                        @endif --}}
                            ...
                            @if (Auth::user()->admin || Auth::user()->B0 || Auth::user()->B1)
                                <li class="nav-item">
                                    ...
                                    <ul id="pages_drp"
                                        class="nav flex-column collapse collapse-level-1 collapse show">
                                        <li class="nav-item">
                                            <ul class="nav flex-column">
                                                <li class="nav-item">
                                                ...
                                                @if (Auth::user()->admin || Auth::user()->B0)
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"href="/posts/addgroups">إضافة مجموعة
                                                            جديدة</a>
                                                    </li>
                                                @endif
        ...
        <script src="{{ asset('control/dist/js/init.js') }}"></script>
        <script src="{{ url('js/imageCropper.js') }}"></script>
        <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/cropper/2.3.4/cropper.min.css'>

        <script src='{{ url('https://cdnjs.cloudflare.com/ajax/libs/cropperjs/0.8.1/cropper.min.js') }}'></script>
